  ...
  return (
    <div className="w-full max-w-[1200px] mx-auto px-4 py-12">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-primary">Committee Chairs</h1>
      </div>
            ...
            {expandedSections[section.title] && (
              <div className="divide-y divide-gray-100">
                {section.members.map((member, memberIndex) => (
                  <div
                    key={memberIndex}
                    className="px-6 py-4 transition-colors duration-200 hover:bg-blue-50"
                  >
                      ...
                      <div className="flex-grow">
                        <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                          <div>
                            ...
                            <div className="text-sm text-[#003366] font-medium mt-1">
                              {member.role}
                            </div>
                          </div>
