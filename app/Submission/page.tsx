...
export default function IcateeePage() {
    return (
        <><Navbar></Navbar><div className="min-h-screen" style={{ background: "var(--background)" }}>
            <div className="container mx-auto px-4 py-12 max-w-4xl mt-40" style={{ color: "var(--foreground)" }}>
                ...
                <div className="rounded-lg shadow-md p-6 mb-8" style={{ background: "rgba(255, 255, 255, 0.5)" }}>
                    ...
                    <div className="space-y-4" style={{ color: "#222222" }}>
                        ...
                        <p>Authors are invited to submit a full paper as PDF file through the Microsoft CMT system (link below):</p>
                        ...
                        <p>
                            All manuscripts will be reviewed blindly by three members of the Technical Program Committee and judged on
                            the basis of their clarity, relevance, originality, and contribution. Please read the author&apos;s
                        ...
                        <p>
                            An accepted paper to be published in the ICATEEE&apos;2025 Conference Proceedings which will be published
                            and indexed later in IEEE Xplorer after getting approval from IEEE, an author is required to register for
                            the conference following the requirements of the registration announced in the website of the conference.
                            All accepted papers MUST be presented at the conference by one of the authors, or, if none of the authors
                            are able to attend, it can be presented by a qualified substitute authorized presenter and arranged in
                            advance by the chair of the conference, however for presenting the paper and answering the questions, this
                            should be arranged in advance during the event with the chair of the session.
                        </p>

                        <div className="mt-6">
                            <h3 className="text-xl font-semibold mb-2" style={{ color: "var(--primary-500)" }}>
                                ICATEEE&apos;2025 Paper templates
                            </h3>
                            <ol className="list-decimal list-inside space-y-1 ml-4">
                                <li>
                                    <a href="#" className="hover:underline" style={{ color: "var(--primary-500)" }}>
                                        Microsoft Word
                                    </a>
                                </li>
                                <li>
